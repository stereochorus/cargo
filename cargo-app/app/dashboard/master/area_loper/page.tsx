  ...
  return (
    <div className="h-full w-full items-center justify-center bg-white p-5">
      <div className='h-20 w-full justify-center items-center border-b-2 border-green-500 mb-10'>
        <p className='text-green-500 font-bold text-xl md:text-4xl text-center uppercase'>master area loper</p>
      </div>
      <div className="flex mb-14 md:mb-0 w-full md:w-[50%] flex-col justify-start">
        ...
        <div className="mt-14 h-12 items-center justify-center">
          <label
            htmlFor="areakirim"
            className="mb-2 block text-sm font-bold font-medium uppercase"
          >
            AREA KIRIM (KOTA/KECAMATAN/KELURAHAN/KODEPOS)
          </label>
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                id="areakirim"
                name="areakirim"
                placeholder="Masukan Area Kirim"
