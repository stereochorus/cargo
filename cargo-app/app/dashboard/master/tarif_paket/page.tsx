  ...
  return (
    <div className="h-full w-full items-center justify-center bg-white p-5">
      <div className='h-20 w-full justify-center items-center border-b-2 border-green-500 mb-10'>
        <p className='text-green-500 font-bold text-xl md:text-4xl text-center uppercase'>master harga</p>
      </div>
      ...
      <div className="flex flex-col justify-center w-full items-center md:h-28 md:flex-row md:justify-between">
        ...
        <Button className="bg-yellow-500 justify-center mt-2 w-full md:w-36 md:ml-5 md:mt-0 capitalize">upload csv</Button>
        <Button className="bg-gray-500 justify-center mt-2 w-full md:w-52 md:ml-5 md:mt-0 capitalize">set harga presentase (%)</Button>
        </div>
